...
| Official Lua 5.5 basic dashboard | `zig build test-official` or `just official-ci` | Pass as dashboard | Current summary: `clua_passed=33`, `clua_failed=0`, `zlua_passed=10`, `categorized_failed=23`, `unexpected_failed=0`. Categorized zlua failures remain expected work items. |
...
| `big.lua` | Pass | Pass |  |
| `bitwise.lua` | Pass | XFail | `runtime` |
| `bwcoercion.lua` | Pass | XFail | `runtime` |
